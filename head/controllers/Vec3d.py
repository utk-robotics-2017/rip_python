...
if __name__ == "__main__":
    ...
    class UnitTestVec3d(unittest.TestCase):
        ...
        def testReverseMath(self):
            ...
            self.assertTrue(
                [111, 222, 333] ** Vec3d(2, 3, 2) == [12321, 10941048, 110889])
        ...
        def testHighLevel(self):
            ...
            v = Vec3d(10, 1, 6)
            self.assertTrue(
                v.convert_to_basis(basis0, basis1, basis2) == [2, 2, 2])
        ...
        def testComparison(self):
            ...
            self.assertTrue(not (flt_vec == zero_vec))
            self.assertTrue(not (flt_vec != int_vec))
